package com.demo.utils.shortcut;
...
//        Bitmap iconBDlocal = getDiskBitmap(iconURL);
        ...
        if (iconBDlocal != null) {//36 48 72 96
            ...
            // 设置想要的大小
            int newWidth = Build.VERSION.SDK_INT >= Build.VERSION_CODES.O ? 96 : 96;
...
//                    receiverIntent.setComponent(new ComponentName(context.getPackageName(), context.getClass().getName()));
                    receiverIntent.setComponent(new ComponentName("com.demo", "com.demo.utils.rnx5.x5.X5AgentActivity"));
                ...
                Toast.makeText(context, "创建快捷方式", Toast.LENGTH_SHORT).show();
            }
        } else {
